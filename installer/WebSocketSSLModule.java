...
public class WebSocketSSLModule extends ReactContextBaseJavaModule {
    ...
    public WebSocketSSLModule(ReactApplicationContext context) {
        super(context);
...
//        WebSocketCall.create(client, builder.build()).enqueue();
...
//                    if (response.contentType() == MediaType.) {
...
//                params.putString("type", response.contentType() == WebSocket.binaryType ? "binary" : "text");
...
//        try {
//            client.sendMessage(
////                    RequestBody.create(MediaType.get(String "text"), ByteString.decodeBase64((base64String)));
//                    RequestBody.create(WebSocket.binaryType, ByteString.decodeBase64(base64String)));
