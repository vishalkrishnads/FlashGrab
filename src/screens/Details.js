...
import { View, Text, Alert, Image, TouchableOpacity, Linking } from 'react-native'
            ...
            <View style={{ flex: 8 }}>
                ...
                <View style={{ flex: 5 }}>
                    ...
                    <View style={{ flex: 3, flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <View style={{ flex: 1 }}></View>
                        <Card heading={'URL'} icon={<EvilIcon name={'external-link'} style={styles.card_icon} />} onpress={() => Linking.openURL(data.url)} />
                        <View style={{ flex: 1 }}></View>
                    </View>
                    <View style={{ flex: 3, flexDirection: 'row', alignItems: 'center' }}>
                        <View style={{ flex: 1 }}></View>
